...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('vel_scale', default_value='0.9',
                              description='Velocity scaling 0.9'),
        DeclareLaunchArgument('acc_scale', default_value='0.25',
                              description='Acceleration scaling 0.25'),
